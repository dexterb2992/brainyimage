...
class RegisterController
{
    ...
    public function validate($inputs)
    {
        ...
        if (!filter_var($inputs['email'], FILTER_VALIDATE_EMAIL)) {
            $errors['email'][] = "The email you entered is not a valid email address.";
        }

        // check email if already exists
        if ($this->emailExists($inputs['email'])) {
        ...
        if (!Helper::checkLicenseKey($inputs['license_key'], $inputs['email'])) {
            $errors['license_key'][] = "Sorry, we can't find the license and email that you entered on our records.";
        }

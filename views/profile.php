    			...
    			<div class="col-md-12">
    				<ul class="nav nav-tabs">
		    			<li class="nav-item active">
		    				<a href="#form_profile" class="nav-link" data-toggle="tab" role="tab" aria-controls="general_info">General Info</a>
		    			</li>
		    			<li class="nav-item">
		    				<a href="#form_password" class="nav-link" data-toggle="tab" aria-controls="password_settings">Password Settings</a>
		    			</li>
		    			<li class="nav-item">
		    				<a href="#form_avatar" class="nav-link" data-toggle="tab" aria-controls="avatar">Avatar</a>
		    			</li>
		    		</ul>
    			</div>
    		</div>
    		...
    		<div class="row">
    			<div class="col-md-12">
		    		<div class="tab-content">
		    			<form id="form_profile" class="tab-pane active" role="tabpanel" method="post" action="./profile.php">
			    			...
			    			<div class="form-group">
			    				<button class="btn btn-success pull-right" type="submit" name="form_profile_submit">
			    					<i class="fa fa-check"></i> Save changes
			    				</button>
			    			</div>
			    		</form>

			    		<form id="form_password" class="tab-pane" role="tabpanel" method="post" action="./profile.php">
			    			<div class="form-group">
			    			...
			    			<div class="form-group">
			    				<button class="btn btn-success pull-right" type="submit" name="form_password_submit">
			    					<i class="fa fa-check"></i> Save changes
			    				</button>
			    			</div>
			    		</form>

			    		<form id="form_avatar" class="tab-pane" role="tabpanel" method="post" action="./profile.php" enctype="multipart/form-data">
			    			<div class="form-group">
			    			...
			    			<div class="form-group">
			    				...
			    				<button class="btn btn-success btn-sm" type="submit" name="form_avatar_submit">
			    					<i class="fa fa-check"></i> Save changes
			    				</button>
			    			</div>
			    		</form>
